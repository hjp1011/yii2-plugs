...
/**
 * This is the main module class for the Plugs module.
 *
 * To use Plugs, include it as a module in the application configuration like the following:
 *
 * ~~~
 * return [
 *     'bootstrap' => ['gii'],
 ...
 * ~~~
 *
 * Because Plugs generates new code files on the server, you should only use it on your own
 * development machine. To prevent other people from using this module, by default, Plugs
 ...
 *
 * With the above configuration, you will be able to access PlugsModule in your browser using
 * the URL `http://localhost/path/to/index.php?r=plugs`
 *
 * If your application enables [[\yii\web\UrlManager::enablePrettyUrl|pretty URLs]],
 * you can then access Plugs via URL: `http://localhost/path/to/index.php/plugs`
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'yiiframe\plugs\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            $app->getUrlManager()->addRules([
                ['class' => 'yii\web\UrlRule', 'pattern' => $this->id, 'route' => $this->id . '/addons/index'],
                ['class' => 'yii\web\UrlRule', 'pattern' => $this->id . '/<id:\w+>', 'route' => $this->id . '/addons/view'],
            ], false);
        } 
    }
    ...
    protected function checkAccess()
    {
        ...
        Yii::warning('Access to Plugs is denied due to IP address restriction. The requested IP is ' . $ip, __METHOD__);
